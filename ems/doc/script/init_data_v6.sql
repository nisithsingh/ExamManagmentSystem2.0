...
INSERT INTO `exampaper` VALUES (1,'2014-10-31',180,'2014-11-05',1,'java exam'),(20,'2014-11-09',53,'2014-11-18',1,'asdasd');
...
CREATE TABLE `examsection` (
  ...
  CONSTRAINT `FK_EXAMSECTION_EXAMPAPER_ID` FOREIGN KEY (`EXAMPAPER_ID`) REFERENCES `exampaper` (`ID`) ON DELETE CASCADE
...
INSERT INTO `examsection` VALUES (1,'section 1',1,5,1),(3,'asdasdas',0,22,NULL),(4,'test',0,9,NULL),(18,'asdasd',0,11,20);
/*!40000 ALTER TABLE `examsection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `examsection_question`
--

DROP TABLE IF EXISTS `examsection_question`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `examsection_question` (
  `ExamSections_ID` bigint(20) NOT NULL,
  `questions_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ExamSections_ID`,`questions_ID`),
  KEY `FK_EXAMSECTION_QUESTION_questions_ID` (`questions_ID`),
  CONSTRAINT `FK_EXAMSECTION_QUESTION_ExamSection_ID` FOREIGN KEY (`ExamSections_ID`) REFERENCES `examsection` (`ID`),
  CONSTRAINT `FK_EXAMSECTION_QUESTION_questions_ID` FOREIGN KEY (`questions_ID`) REFERENCES `question` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `examsection_question`
--

LOCK TABLES `examsection_question` WRITE;
/*!40000 ALTER TABLE `examsection_question` DISABLE KEYS */;
INSERT INTO `examsection_question` VALUES (18,57),(18,58);
/*!40000 ALTER TABLE `examsection_question` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `examsection_subjecttag`
--

DROP TABLE IF EXISTS `examsection_subjecttag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `examsection_subjecttag` (
  `subjectTags_ID` bigint(20) NOT NULL,
  `examSections_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`subjectTags_ID`,`examSections_ID`),
  KEY `FK_EXAMSECTION_SUBJECTTAG_examSections_ID` (`examSections_ID`),
  CONSTRAINT `FK_EXAMSECTION_SUBJECTTAG_examSections_ID` FOREIGN KEY (`examSections_ID`) REFERENCES `examsection` (`ID`),
  CONSTRAINT `FK_EXAMSECTION_SUBJECTTAG_subjectTags_ID` FOREIGN KEY (`subjectTags_ID`) REFERENCES `subjecttag` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `examsection_subjecttag`
--

LOCK TABLES `examsection_subjecttag` WRITE;
/*!40000 ALTER TABLE `examsection_subjecttag` DISABLE KEYS */;
INSERT INTO `examsection_subjecttag` VALUES (1,3),(1,4),(1,18);
/*!40000 ALTER TABLE `examsection_subjecttag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `examsession` (
  ...
  CONSTRAINT `FK_EXAMSESSION_EXAMPAPER_ID` FOREIGN KEY (`EXAMPAPER_ID`) REFERENCES `exampaper` (`ID`) ON DELETE CASCADE,
...
CREATE TABLE `question` (
  ...
  `PREVIOUSQUESTION_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_QUESTION_CREATEDBY_ID` (`CREATEDBY_ID`),
  KEY `FK_QUESTION_MODULE_ID_idx` (`MODULE_ID`),
  KEY `FK_QUESTION_QUESTION_ID_idx` (`PREVIOUSQUESTION_ID`),
  ...
  CONSTRAINT `FK_QUESTION_QUESTION_ID` FOREIGN KEY (`PREVIOUSQUESTION_ID`) REFERENCES `question` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `question` VALUES (1,'2014-10-31',2,'question 1',1,0,1,1,NULL,NULL),(2,'2014-10-31',3,'question 2',1,0,1,1,NULL,NULL),(3,'2014-11-05',2,'asasdsadsad',0,0,1,1,NULL,NULL),(4,'2014-11-05',2,'<span style=\"font-weight: bold;\">aasdasdsad</span>',0,0,1,1,NULL,NULL),(5,'2014-11-05',3,'asdasd',0,0,1,1,NULL,NULL),(6,'2014-11-05',6,'sdasd',0,0,1,1,NULL,NULL),(7,'2014-11-05',4,'test',0,0,1,1,NULL,NULL),(8,'2014-11-05',5,'test 2',0,0,1,1,NULL,NULL),(9,'2014-11-05',3,'test 3',0,0,1,1,NULL,NULL),(10,'2014-11-05',3,'asdasd',0,0,1,1,NULL,NULL),(11,'2014-11-05',5,'asdadsd',0,0,1,1,NULL,NULL),(12,'2014-11-06',233,'asdasd',0,0,1,1,NULL,NULL),(13,'2014-11-06',12,'milandasasd',0,0,1,1,NULL,NULL),(14,'2014-11-06',100,'test milan questio',0,0,1,1,NULL,NULL),(15,'2014-11-06',3,'sadasda',0,0,1,1,NULL,NULL),(16,'2014-11-06',12,'sdasd',0,0,1,1,NULL,NULL),(17,'2014-11-06',324,'sdasdasd',0,0,1,2,NULL,NULL),(18,'2014-11-06',2342,'asdasd',0,0,1,1,NULL,NULL),(19,'2014-11-06',3,'asdasd',0,0,1,2,NULL,NULL),(20,'2014-11-06',3,'asdasd',0,0,1,1,NULL,NULL),(21,'2014-11-06',4,'asdasdasd',0,0,1,1,NULL,NULL),(22,'2014-11-06',32,'asdasdasd',0,0,1,1,NULL,NULL),(23,'2014-11-06',32,'asdasdasdasd',0,0,1,1,NULL,NULL),(24,'2014-11-06',2321,'asdasdsd',0,0,1,1,NULL,NULL),(25,'2014-11-06',232,'dasdasd',0,0,1,1,NULL,NULL),(26,'2014-11-06',23,'asdadasd',0,0,1,1,NULL,NULL),(27,'2014-11-06',23,'asdasdasd',0,0,1,1,NULL,NULL),(28,'2014-11-06',32,'asdasdsad',0,0,1,1,NULL,NULL),(29,'2014-11-06',43,'adasdsad',0,0,1,1,NULL,NULL),(30,'2014-11-06',234,'qdasdasd',0,0,1,2,NULL,NULL),(31,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(32,'2014-11-07',34,'multiple correct',1,0,1,1,1,NULL),(33,'2014-11-07',21,'essay',2,0,1,1,1,NULL),(34,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(35,'2014-11-07',34,'multiple correct',1,0,1,1,1,NULL),(36,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(37,'2014-11-07',34,'multiple correct',1,0,1,1,1,NULL),(38,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(39,'2014-11-07',21,'essay',2,0,1,1,1,NULL),(40,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(41,'2014-11-06',2,'asdas',0,0,1,1,1,NULL),(42,'2014-11-07',21,'essay',2,0,1,1,1,NULL),(43,'2014-11-07',34,'multiple correct',1,0,1,1,1,NULL),(44,'2014-11-07',12,'asdadasd',0,NULL,NULL,1,1,NULL),(45,'2014-11-07',23,'asddaasdasd',0,0,1,1,1,NULL),(46,'2014-11-07',12,'asdadsad',0,0,1,1,1,NULL),(47,'2014-11-07',23,'milan',0,0,1,1,1,NULL),(48,'2014-11-07',23,'milan test',0,0,1,1,1,NULL),(49,'2014-11-07',12,'<b>sadasdasd</b>',0,0,1,1,1,NULL),(50,'2014-11-07',12,'<b>sadasdasd.modified</b>',0,0,1,1,1,NULL),(51,'2014-11-07',23,'asdasdsd',0,0,1,1,1,NULL),(52,'2014-11-07',23,'asdasdsd.modified',0,1,1,1,1,51),(53,'2014-11-07',21,'asdasdasd',0,0,1,1,1,NULL),(54,'2014-11-07',21,'asdasdasd &nbsp;modified',0,1,1,1,1,53),(55,'2014-11-07',12,'asdasdsd',0,0,1,1,1,NULL),(56,'2014-11-07',12,'<i><b>asdasdsd.1</b></i>',0,1,1,1,0,55),(57,'2014-11-09',5,'test',0,0,1,1,0,NULL),(58,'2014-11-09',5,'tesadsd',0,0,1,1,0,NULL);
...
INSERT INTO `question_subjecttag` VALUES (16,1),(17,1),(18,1),(19,1),(20,1),(21,1),(22,1),(23,1),(24,1),(25,1),(26,1),(27,1),(28,1),(29,1),(30,1),(31,1),(32,1),(33,1),(34,1),(35,1),(36,1),(37,1),(38,1),(39,1),(40,1),(41,1),(42,1),(43,1),(44,1),(46,1),(47,1),(48,1),(49,1),(50,1),(51,1),(52,1),(53,1),(54,1),(55,1),(56,1),(57,1),(58,1),(16,2),(17,2),(18,2),(19,2),(23,2),(32,2),(33,2),(35,2),(37,2),(39,2),(42,2),(43,2),(45,2),(47,2),(48,2);
...
INSERT INTO `student` VALUES (1,'student','milan'),(2,'milanstudent','milan student');
...
CREATE TABLE `studentanswer` (
  ...
  CONSTRAINT `FK_STUDENTANSWER_EXAMSESSION_ID` FOREIGN KEY (`EXAMSESSION_ID`) REFERENCES `examsession` (`ID`) ON DELETE CASCADE,
...
INSERT INTO `users` VALUES ('admin','admin'),('lecturer','lecturer'),('milanstudent','milanstudent'),('student','student');
...
INSERT INTO `users_groups` VALUES ('admin','admin',1),('lecturer','lecturer',2),('student','milanstudent',3),('student','student',4);
...
-- Dump completed on 2014-11-26 21:57:18
